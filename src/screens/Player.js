...
export default function Player(props) {
  ...
  const buttonLeft = () => (
    <IconButton icon="window-close" color="white" style={{ marginLeft: 15 }} size={24} onPress={() => closeVideo()} />
  );
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Button icon="web" mode="contained" onPress={openInBrowser} style={styles.openInBrowserButton}>
        Open in Browser
      </Button>
    </View>
  );
