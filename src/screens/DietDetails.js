...
import { View, SafeAreaView, ImageBackground, ScrollView, useWindowDimensions,Linking   } from 'react-native';
    ...
    <View style={{marginTop:15, marginHorizontal:15}}>
      {/*   <Card style={{marginBottom:15, borderWidth:0}} mode={'outlined'}>
        ...
        <Card style={{marginBottom:15, borderWidth:0}} mode={'outlined'}>
            ...
            <Text style={{ color: 'blue', textDecorationLine: 'underline' }} onPress={() => Linking.openURL(item.link)}>
          {item.link}
        </Text> 
                   </Card.Content>
        </Card>
