...
export default function FourteenthComponent({ onSelectValue, ...props }) {
...
if(isLoaded){
 ...
 <ProgressBar progress={42}  height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>14/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:15,fontWeight:'800',textAlign:'center' }}>{Strings.q13}  </Text>
</View>
