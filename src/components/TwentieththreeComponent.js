...
if(isLoaded){
 ...
 <ProgressBar progress={69}  height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>21/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:16,fontWeight:'800' }}>{Strings.q22}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/sleep1.jpg')}
...
>
<ImageBackground
      source={ require('../../images/sleep2.jpg')}
...
>
<ImageBackground
      source={ require('../../images/sleep3.jpg')}
...
>
<ImageBackground
      source={ require('../../images/sleep4.jpg')}
