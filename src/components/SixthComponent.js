...
export default function SixthComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={18} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>6/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:17,fontWeight:'800' }}>{Strings.q5}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/goal_1516827131.jpg')}
...
>
<ImageBackground
      source={ require('../../images/goal_1516827143.jpg')}
...
>
<ImageBackground
      source={ require('../../images/post_1519977985.jpg')}
...
>
<ImageBackground
      source={ require('../../images/level_1517336508.jpg')}
        ...
        <Grid>
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              mode='contained'
              onPress={() => onChangeScreen("SeventhComponent")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
