...
export default function FifthComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={15} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>5/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:17,fontWeight:'800' }}>{Strings.q4}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/level_1516827206.jpg')}
...
>
<ImageBackground
      source={ require('../../images/workout_1519946537.jpg')}
...
>
<ImageBackground
      source={ require('../../images/workout_1519950276.jpg')}
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             icon={language=='ar' ? "arrow-right-bold" : "arrow-left-bold"}
              mode='text'
              onPress={() => onChangeScreen("FourthComponent")}     
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              mode='contained'
              onPress={() => onChangeScreen("SixthComponent")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
