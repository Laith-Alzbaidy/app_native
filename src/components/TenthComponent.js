...
export default function TenthComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={30} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>10/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:15,fontWeight:'800' }}>{Strings.q9}  </Text>
</View>
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              disabled={false}
              mode='text'
              onPress={() => onChangeScreen("NinthComponent")}     
