...
export default function SecondComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={6} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>2/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:20,fontWeight:'800' }}>{Strings.primary_goal}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/workout_1519950433.jpg')}
...
>
<ImageBackground
      source={ require('../../images/goal_1516827137.jpg')}
...
>
<ImageBackground
      source={ require('../../images/workout_1519949966.jpg')}
      ...
      <Row>
        ...
        >
          ...
          >
            <View style={Styles.optionContainer}>
              <Text numberOfLines={2} style={Styles.card1_title2}>
              {Strings.Develop_healthy_habits}
                </Text>
            </View>
            <View style={{ justifyContent: "flex-end",marginTop:50 }}>
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             icon={language=='ar' ? "arrow-right-bold" : "arrow-left-bold"}
              mode='text'
              onPress={() => onChangeScreen("FirstComponent")}     
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              mode='contained'
              onPress={() => onChangeScreen("ThirdComponent")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
