...
export default function ({ onSelectValue, ...props }) {
...
if(isLoaded){
 ...
 <ProgressBar progress={39}  height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>13/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:15,fontWeight:'800',textAlign:'center' }}>{Strings.q12}  </Text>
</View>
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             disabled={false}
              mode='text'
              onPress={() => onChangeScreen("TwelfthComponent")}     
