...
export default function SixteenthComponent({ user_data,onSelectValue, ...props }) {
  ...
  const handleCustomPress=(option)=>{
    if(selectedOption==1){
      onChangeScreen("SeventeenthComponent")
  
    }else {
  onChangeScreen("TwentiethOneComponent");
    }
  }
...
if(isLoaded){
 ...
 <ProgressBar progress={48} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:5,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 20,fontSize:20 }}>16/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 20,fontSize:20,fontWeight:'800',textAlign:'center' }}>{Strings.q15}  </Text>
</View>
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             disabled={false}
              mode='text'
              onPress={() => onChangeScreen("FifteenthComponent")}     
