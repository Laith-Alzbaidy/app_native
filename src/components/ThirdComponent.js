...
export default function ThirdComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={9} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:5,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 20,fontSize:20 }}>3/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 20,fontSize:20,fontWeight:'800' }}>{Strings.q2}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/victor-freitas-nA0UDNDbxys-unsplash.jpg')}
...
>
<ImageBackground
      source={ require('../../images/workout_1519949368.jpg')}
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             icon={language=='ar' ? "arrow-right-bold" : "arrow-left-bold"}
              disabled={false}
              mode='text'
              onPress={() => onChangeScreen("SecondComponent")}     
