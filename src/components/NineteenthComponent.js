...
export default function NineteenthComponent({ onSelectValue, ...props }) {
  ...
  return (
    <>
      ...
      <View style={{ width: '100%', paddingHorizontal: 20 }}>
        <ProgressBar progress={57} height={5} backgroundColor={ColorsApp.PRIMARY} />
        <View style={{ display: 'flex', marginVertical: 2, flexDirection: 'row', justifyContent: 'flex-end' }}>
          <Text style={{ marginBottom: 5, fontSize: 20 }}>19/28  </Text>
        </View>
        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ marginBottom: 0, fontSize: 16, fontWeight: '800' }}>{Strings.q18}  </Text>
        </View>
      </View>
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          <TouchableOpacity
            onPress={() => {
        ...
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Eggs.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Yogurt.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
        ...
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Cottage.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Tofu.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
        ...
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Olives.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Peanut.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
        ...
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          ...
          >
            <ImageBackground
              source={require('../../images/Nuts.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
      ...
      <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
        <View style={[Styles.Customecard2, Styles.cardContent3]}>
          <TouchableOpacity
            ...
            onPressIn={() => handlePressIn(9)}
            onPressOut={handlePressOut}
            activeOpacity={1}
            style={[
              { transform: [{ scale: scaleValue }] },
              isSelected(9) ? Styles.selectedOption : null,
            ]}
          >
            <ImageBackground
              source={require('../../images/Mozzarella.jpg')}
              style={Styles.card5_background3}
              imageStyle={{ borderRadius: 8 }}
            >
              <LinearGradient
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             disabled={false}
              mode='text'
              onPress={() => onChangeScreen("EighteenthComponent")}     
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            ...
            disabled={selectedOptions.length === 0}
              ...
              mode='contained'
              onPress={() => onChangeScreen("TwentiethComponent")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
