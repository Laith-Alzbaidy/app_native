...
export default function FourthComponent({ onSelectValue, ...props }) {
 ...
 <ProgressBar progress={12} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>4/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:18,fontWeight:'800' }}>{Strings.q3}  </Text>
</View>
...
>
<ImageBackground
      source={ require('../..//images/level_1516827220.jpg')}
