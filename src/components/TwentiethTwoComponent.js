...
export default function TwelfthTowComponent({ onSelectValue, ...props }) {
...
if(isLoaded){
 ...
 <ProgressBar progress={66} height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>20/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:16,fontWeight:'800',textAlign:'center' }}>{Strings.q21}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/fluctuate.jpg')}
...
>
<ImageBackground
      source={ require('../../images/drag.jpg')}
...
>
<ImageBackground
      source={ require('../../images/sleepy.jpg')}
        ...
        <Grid>
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              mode='contained'
              onPress={() => onChangeScreen("TwentiethThreeComponent")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
