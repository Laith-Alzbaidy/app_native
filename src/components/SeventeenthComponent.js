...
export default function SeventeenthComponent({ onSelectValue, ...props }) {
...
if(isLoaded){
 ...
 <ProgressBar progress={51}  height={5} backgroundColor={ColorsApp.PRIMARY} />

<View style={{display:'flex',marginVertical:2,flexDirection:'row',justifyContent:'flex-end'}}>

<Text style={{ marginBottom: 5,fontSize:20 }}>17/28  </Text>


</View>
<View style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
<Text style={{ marginBottom: 0,fontSize:16,fontWeight:'800' }}>{Strings.q16}  </Text>
</View>
      ...
      <View style={[Styles.Customecard, Styles.cardContent2]}>
        ...
        >
      <ImageBackground
      source={ require('../../images/recipe_1519976739.jpg')}
...
>
<ImageBackground
      source={ require('../../images/recipe_1519975733.jpg')}
...
>
<ImageBackground
      source={ require('../../images/recipe_1519976534.jpg')}
