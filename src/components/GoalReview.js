...
export default function GoalReview({ onSelectValue, ...props }) {
...
<Text style={{ marginBottom: 5,fontSize:20 }}>2/7  </Text>
        ...
        <Grid>
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
             ...
             icon={language=='ar' ? "arrow-right-bold" : "arrow-left-bold"}
              mode='text'
              onPress={() => onChangeScreen("ReviewComponent")}     
          ...
          <Col style={{ justifyContent: "center", alignItems: "center" }}>
            <Button
              ...
              mode='contained'
              onPress={() => onChangeScreen("LevelReview")}     
                       labelStyle={{ fontSize: 16, fontWeight: "bold" }}
