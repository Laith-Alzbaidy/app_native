...
import Send_message from "../screens/Send_message"
import All_message from "../screens/All_message"
import DietdetailsCard from "../screens/DietdetailsCard"
import DietPlanCard from "../screens/DietPlanCard";
import SingleDayFood from "../screens/SingleDayFood";
...
export default function StackNavigation(props) {
  ...
  return (
    <Stack.Navigator screenOptions={navigatorOptions}>
      ...
      />
      <Stack.Screen
        name="dietdetailsCard"
        component={DietdetailsCard}
        options={{ title: Strings.ST27, headerLeft: () => buttonBack() }}
      />
      <Stack.Screen
        name="dietPlanCard"
	  ...
	  <Stack.Screen
        ...
        options={{ title: Strings.send_request, headerLeft: () => buttonBack() }}
      />
      ...
      <Stack.Screen
        name="all_message"
        component={All_message}
        options={{ title: Strings.all_request, headerLeft: () => buttonBack() }}
      />
    </Stack.Navigator>
  );
}
